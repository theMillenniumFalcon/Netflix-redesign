            ...
            <Content>
               <Wrap>
                   ...
                   <video autoPlay = { true } loop = { true } playsInline = { true }>
                      <source src="/videos/aquaman.mp4" type="video/mp4" />
                      </video>
               </Wrap>
               <Wrap>
                   <img src = '/images/john.jpg' alt = '' />
                   <video autoPlay = { true } loop = { true } playsInline = { true }>
                      <source src="/videos/john.mp4" type="video/mp4" />
                      </video>
               </Wrap>
               <Wrap>
                   <img src = '/images/300.jpg' alt = '' />
                   <video autoPlay = { true } loop = { true } playsInline = { true }>
                      <source src="/videos/300.mp4" type="video/mp4" />
                      </video>
                </Wrap>
               <Wrap>
                   <img src = '/images/jurassic.jpg' alt = '' />
                   <video autoPlay = { true } loop = { true } playsInline = { true }>
                      <source src="/videos/jurassic.mp4" type="video/mp4" />
                      </video>
               </Wrap>
               <Wrap>
               ...
               <Wrap>
                   <img src = '/images/squad.jpg' alt = '' />
                   <video autoPlay = { true } loop = { true } playsInline = { true }>
                      <source src="/videos/squad.mp4" type="video/mp4" />
                      </video>
               </Wrap>
               <Wrap>
